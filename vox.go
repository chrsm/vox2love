...
type vox struct {
	pack *pack // if present, multiple models
...
type voxel struct { // 4 bytes, 1 per component
	x, y, z    uint8
	colorIndex uint8
}
...
type material struct {
	...
	// if set, values are set in next section.
	// bit(0) plastic
	// bit(1) roughness
	// bit(2) specular
	// bit(3) IOR
	...
	// * plastic mat only accepts {0.0, 1.0}
	pvalues []uint32
}
